...
Public Function FilterAndCopySpecificColumns( _
    ...
    filterRow = 2
    j = 0
    '«¿Ã≈Õ»“‹ lastColumnNumSource ≈—À» ”¬≈À»◊»“—ﬂ  ŒÀ»◊≈—“¬Œ —“ŒÀ¡÷Œ¬!!!
    ...
    Do While filterRow <> lastRowSource
        ...
        codeFROM <> "" And codeFROM <> codeErrorText Then
            idValue = wsSource.Cells(filterRow, idColumnFROM).Value ' œÓÎÛ˜‡ÂÏ ÁÌ‡˜ÂÌËÂ id
            ' œÓ‚ÂˇÂÏ, ÒÛ˘ÂÒÚ‚ÛÂÚ ÎË ÒÚÓÍ‡ Ò Ú‡ÍËÏ id ‚ ˆÂÎÂ‚ÓÈ ÍÌË„Â
